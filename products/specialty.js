document.addEventListener("DOMContentLoaded", async function () {
    ...
    const response = await fetch('specialty.json');
    ...
    function populateTable(products) {
        ...
        products.forEach((product) => {
            ...
            const ingredient = product["Active Ingredient"];
            const form = product["Form & strength"];
            ...
            activeIngredientCell.textContent = ingredient;
    ...
    requestForm.addEventListener("submit", function (event) {
        ...
        window.location.href = "selected_special.html";
    });
});
